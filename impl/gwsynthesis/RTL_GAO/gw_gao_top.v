module gw_gao(
    ...
    \actualYLast[1] ,
    \actualYLast[0] ,
    updatedStartModeChange,
    updatedEndModeChange,
    PS2_PCLK,
    tms_pad_i,
    tck_pad_i,
    tdi_pad_i,
...
input \actualYLast[1] ;
input \actualYLast[0] ;
input updatedStartModeChange;
input updatedEndModeChange;
input PS2_PCLK;
input tms_pad_i;
input tck_pad_i;
input tdi_pad_i;
...
wire \actualYLast[1] ;
wire \actualYLast[0] ;
wire updatedStartModeChange;
wire updatedEndModeChange;
wire PS2_PCLK;
wire tms_pad_i;
wire tck_pad_i;
wire tdi_pad_i;
